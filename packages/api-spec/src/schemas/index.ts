...
export * from './autoshare-rules.ts'
export * from './deduction-rules.ts'
export * from './correlations.ts'
export * from './data-schema.ts'
export * from './feed-structured.ts'
export * from './feed.ts'
export * from './food-item-portions.ts'
export * from './food-items.ts'
export * from './garmin-watch.ts'
...
export * from './nutrient-recommendations.ts'
