...
| [**Media players (MPRIS)**](./media.md)           | Video, music and podcast plays with URL, played time and track length (Linux desktop)                  | Push (logger script)                   | None                               | Run the MPRIS logger + push script                       |
