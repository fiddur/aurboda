...
Phone positions are the fallback track: where an activity carries its own GPS (Garmin, Strava), that track takes precedence for the activity's span and the phone points are soft-deleted -- see [GPS Precedence](./data-sources.md#gps-precedence).
